...
public class CaptureHelper extends ScreenRecorder{
    ...
    public static void startRecord(String methodName) {
        ...
        File file = new File(ConfigManager.getRecordVideoPath() + File.separator + methodName + File.separator);
        if (!file.exists()) {
            file.mkdirs();
        }
    ...
    public static void stopRecord(){
        if (!ConfigManager.isRecordVideoEnabled() || screenRecorder == null) {
            return;
        }
    ...
    public static void takeScreenshot(ITestResult result) {
        ...
        File theDir = new File(ConfigManager.getScreenshotPath());
        if (!theDir.exists()) {
            theDir.mkdirs();
        }
        ...
        try {
            ...
            FileHandler.copy(source, new File(ConfigManager.getScreenshotPath() + result.getName() + ".png"));
    ...
    public static void takeScreenshot(String name) {
        ...
        try {
            ...
            FileHandler.copy(source, new File(ConfigManager.getScreenshotPath() + name + ".png"));
